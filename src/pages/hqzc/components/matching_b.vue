  ...
  <div class="matchingB">
    <div class="matchingB_container">
      ...
      <el-form :inline="true" ref="form" :model="form" label-width="150px">
          ...
          <el-form-item label="意向产业:" label-width="100px" >
              <el-select v-model="form.intentionIndustry" clearable placeholder="活动区域">
                <el-option 
