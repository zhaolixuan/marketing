<template>
  <container
    title="本国从各国家/地区进口比例统计（交易次数）"
    subtitle="2018.12-2021.12"
  >
    <div class="echarts-wrap" v-show="!noData">
      <div class="echarts" ref="echarts"></div>
      <div class="circle">
        <div class="echarts-title-zh">交易次数占比</div>
        <div class="echarts-title-en">Economic Entity</div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    // 获取数据
    async getData() {
      const res = await api.getGlobalCountryAreaAnalysisDealNumberData({
